...
class InscriptionUtilsTest {

    @Test
    void isAbove16Test(){
        // Cas 1 : Âge supérieur à 16 ans
        String validDateOfBirth = "2000-01-01";
        assertTrue(InscriptionUtils.isAgeAbove16(validDateOfBirth),
            "Une personne née le 2000-01-01 devrait être validée comme ayant plus de 16 ans.");

        // Cas 2 : Âge exactement 16 ans
        String exact16YearsOld = LocalDate.now().minusYears(16).toString();
        assertTrue(InscriptionUtils.isAgeAbove16(exact16YearsOld),
            "Une personne née il y a exactement 16 ans aujourd'hui devrait être validée.");

        // Cas 3 : Âge inférieur à 16 ans
        String below16YearsOld = "2010-01-01";
        assertFalse(InscriptionUtils.isAgeAbove16(below16YearsOld),
            "Une personne née le 2010-01-01 ne devrait pas être validée comme ayant plus de 16 ans.");

        // Cas 4 : Date future
        String futureDateOfBirth = "2025-01-01";
        assertFalse(InscriptionUtils.isAgeAbove16(futureDateOfBirth),
            "Une date de naissance dans le futur ne devrait pas être validée.");
    }
    ...
    void isValidPasswordTest() {
        ...
        assertEquals("Minimum of 8 character required", InscriptionUtils.isValidPassword("Pass1"),
            "Un mot de passe trop court devrait retourner un message d'erreur.");
        ...
        assertEquals("Minimum of 1 capital letter and 1 number required",
            ...
            "Un mot de passe sans majuscule et chiffre devrait retourner un message d'erreur.");
