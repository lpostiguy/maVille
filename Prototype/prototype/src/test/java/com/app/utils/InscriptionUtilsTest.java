...
public class InscriptionUtilsTest {
    ...
    public void isAbove16Test() {
        ...
        assertTrue(InscriptionUtils.isAgeAbove16(validDateOfBirth), "Une " +
            "personne née le 2000-01-01 devrait être validée comme ayant plus" +
            " de 16 ans.");
        ...
        assertTrue(InscriptionUtils.isAgeAbove16(exact16YearsOld), "Une " +
            "personne née il y a exactement 16 ans aujourd'hui devrait être " +
            "validée.");
        ...
        assertFalse(InscriptionUtils.isAgeAbove16(below16YearsOld), "Une " +
            "personne née le 2010-01-01 ne devrait pas être validée comme " +
            "ayant plus de 16 ans.");

        // Cas 4 : Date future
        String futureDateOfBirth = "2025-01-01";
        assertFalse(InscriptionUtils.isAgeAbove16(futureDateOfBirth), "Une " +
            "date de naissance dans le futur ne devrait pas être validée.");
    }

    @Test
    public void isValidPasswordTest() {
        // Cas où le mot de passe est valide
        assertEquals("", InscriptionUtils.isValidPassword("Password1"), "Un " +
            "mot de passe valide devrait retourner une chaîne vide.");
        ...
        assertEquals("Minimum of 1 capital letter and 1 number required",
            InscriptionUtils.isValidPassword("password"), "Un mot de passe " +
                "sans majuscule et chiffre devrait retourner un message " +
                "d'erreur.");

        // Cas où le mot de passe manque un chiffre
        assertEquals("Minimum of 1 capital letter and 1 number required",
            InscriptionUtils.isValidPassword("PASSWORD"), "Un mot de passe " +
                "sans chiffre devrait retourner un message d'erreur.");
    }
